...
React 使用 Virtual DOM 的核心目的，不是“绝对更快”，而是：
 ...
 2.	让跨平台渲染成为可能
React 的核心 reconciler 不直接依赖浏览器 DOM，因此可以扩展到 React Native，实现一套代码多端渲染。
 3.	性能优化：通过 Diff 降低不必要的 DOM 操作
...
**总结：**
Virtual DOM 的真正优势在于：在保证性能“足够好”的同时，极大地提高了开发效率和代码的可维护性。
...
区别总结
 - useTransition：标记某个 state 更新为低优先级，保证UI不卡顿。
